  ...
  <div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="text-right">
          <a href="http://localhost/travel/controller/admin_adduser.php" class="btn btn-primary btn-sm mb-2 mr-5">Add User</a>
        </div>
        <table class="table">
            <thead>
              <tr>
          ...
          if ($result -> num_rows > 0){
              ...
              <tr>
                ...
                <td>
                  <a href="http://localhost/travel/controller/admin_edituser.php?id=<?php echo $row["id"]; ?>" class="btn btn-info btn-sm">Edit</a>
                  <a href="http://localhost/travel/controller/admin_deleteuser.php?id=<?php echo $row["id"]; ?>" class="btn btn-danger btn-sm">Delete</a>
